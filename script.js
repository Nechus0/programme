...
function renderPatientCard(p){
    ...
    const openIcon='<span class="icon-btn" onclick="event.stopPropagation();loadPatient(\''+p.id+'\')" title="'+(LANG==='de'?'Öffnen':'Open')+'">'+PENCIL_SVG+'</span>';

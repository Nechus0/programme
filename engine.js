...
window.EngineCtx = {
  ...
  getConds: () => { return EngineCtx.getConds(); },
  getDestinations: () => { return window.EngineCtx.getDestinations() || []; },
  getVaxState: () => { return window.EngineCtx.getVaxState() || {}; },
  getMedsList: () => { return window.EngineCtx.getMedsList() || []; },

...
function renderMedList(){
  ...
  box.innerHTML='<div class="vc-title">'+title+'</div>'+medsList.map((m,i)=>{
    ...
    return '<div class="vc-card red"><div class="vc-h"><span class="vc-name">'+_esc(d.substance)+brands(d)+'</span><span class="vc-hr"><span class="vc-badge red">'+(LX('Immunsuppressivum','Immunosuppressant'))+'</span>'+rm+'</span></div>'+(d.unverified?'<div class="vc-note" style="color:#9a5b00;font-weight:600;">'+(LX('\u26a0 Vorl\u00e4ufig \u2013 automatisch anhand der Substanzklasse eingeordnet, noch nicht einzeln gepr\u00fcft.','\u26a0 Provisional \u2013 auto-classified by substance class, not individually verified.'))+'</div>':'')+(d.category?'<div class="vc-cat">'+_esc(d.category)+'</div>':'')+

...
function renderMedList(){
  ...
  box.innerHTML='<div class="vc-title">'+title+'</div>'+medsList.map((m,i)=>{
    ...
    if(d.checkpoint) return '<div class="vc-card amber"><div class="vc-h"><span class="vc-name">'+_esc(d.substance)+brands(d)+'</span><span class="vc-hr"><span class="vc-badge amber">'+(LX('Checkpoint-Inhibitor','Checkpoint inhibitor'))+'</span>'+rm+'</span></div>'+(d.description?'<div class="vc-desc">'+_esc(d.description)+'</div>':'')+'<div class="vc-note">'+(LX('Immunstimulierend \u2013 kein klassisches Immunsuppressivum. Lebendimpfstoffe w\u00e4hrend der Therapie i.\u2009d.\u2009R. vermeiden (individuelle Abw\u00e4gung, Risiko immunvermittelter Reaktionen); Totimpfstoffe m\u00f6glich.','Immunostimulatory \u2013 not classic immunosuppression. Avoid live vaccines during therapy (individual assessment); inactivated vaccines possible.'))+'</div></div>';
    if(!d.is_immunosuppressant) return '<div class="vc-card green"><div class="vc-h"><span class="vc-name">'+_esc(d.substance)+brands(d)+'</span><span class="vc-hr"><span class="vc-badge green">'+(LX('unkritisch','no concern'))+'</span>'+rm+'</span></div>'+(d.description?'<div class="vc-desc">'+_esc(d.description)+'</div>':'')+(d.category?'<div class="vc-cat">'+_esc(d.category)+'</div>':'')+'</div>';
    return '<div class="vc-card red"><div class="vc-h"><span class="vc-name">'+_esc(d.substance)+brands(d)+'</span><span class="vc-hr"><span class="vc-badge red">'+(LX('Immunsuppressivum','Immunosuppressant'))+'</span>'+rm+'</span></div>'+(d.unverified?'<div class="vc-note" style="color:#9a5b00;font-weight:600;">'+(LX('\u26a0 Unsichere Datenlage \u2013 vorsorglich als immunsuppressiv gef\u00fchrt; individuelle Abw\u00e4gung empfohlen.','\u26a0 Uncertain evidence \u2013 treated as immunosuppressive as a precaution; individual assessment recommended.'))+'</div>':'')+(d.category?'<div class="vc-cat">'+_esc(d.category)+'</div>':'')+
